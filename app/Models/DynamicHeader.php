...
class DynamicHeader extends Model
{
    ...
    protected $table = 'dynamic_headers';
    ...
    public function child()
    {
        ...
        return $this->hasMany(DynamicHeader::class, 'pid', 'id')->with([
    ...
    {
        return $this->hasMany(DynamicHeader::class, 'pid', 'id')->with('menus')->orderBy('serials')->select('id', 'node_name', 'pid', 'route_name','route_location', 'serials', 'status', 'icon');
    }
