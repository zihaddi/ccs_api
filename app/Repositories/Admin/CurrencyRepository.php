...
class CurrencyRepository extends BaseRepository implements CurrencyRepositoryInterface
{
    ...
    public function index($obj, $request)
    {
        try {
            ...
            if ($query) {
                $responseData = CurrencyResource::collection($query)->response()->getData();
    ...
    // Store: Create a new Currency
    public function store($obj, $request)
    {
        try {
            $Currency = $obj::create($request);
            if ($Currency) {
                return $this->success(new CurrencyResource($Currency), Constants::STORE, Response::HTTP_CREATED, true);
            } else {
    ...
    {
        try {
            $Currency = $obj::find($id)->with('category');
            if ($Currency) {
    ...
    // Update: Fully update an Currency
    public function update($obj, $request, $id)
    {
        try {
            ...
            if ($obj) {
                ...
                if ($updated) {
                    return $this->success(new CurrencyResource($obj), Constants::UPDATE, Response::HTTP_CREATED, true);
                } else {
    ...
    // Patch: Partially update an Currency
    public function patch($obj, $request)
    {
        try {
            $updated = $obj->update($request->all());
            if ($updated) {
                return $this->success(new CurrencyResource($obj), Constants::PATCH, Response::HTTP_CREATED, true);
            } else {
    ...
    public function restore($obj, $id)
    {
        try {
            ...
            if ($data) {
                $data->restore();
                return $this->success(new CurrencyResource($data), Constants::RESTORE, Response::HTTP_CREATED, true);
            } else {
