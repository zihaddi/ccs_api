...
class TagRepository extends BaseRepository implements TagRepositoryInterface
{
    ...
    public function index($obj, $request)
    {
        try {
            ...
            if ($query) {
                $responseData = TagResource::collection($query)->response()->getData();
    ...
    public function store($obj, $request)
    {
        try {
            ...
            if ($tag) {
                return $this->success(new TagResource($tag), Constants::STORE, Response::HTTP_CREATED, true);
            } else {
    ...
    public function update($obj, $request, $id)
    {
        try {
            ...
            if ($obj) {
                ...
                if ($updated) {
                    return $this->success(new TagResource($obj), Constants::UPDATE, Response::HTTP_CREATED, true);
                } else {
    ...
    public function patch($obj, $request)
    {
        try {
            ...
            if ($updated) {
                return $this->success(new TagResource($obj), Constants::PATCH, Response::HTTP_CREATED, true);
            } else {
    ...
    public function restore($obj, $id)
    {
        try {
            ...
            if ($data) {
                $data->restore();
                return $this->success(new TagResource($data), Constants::RESTORE, Response::HTTP_CREATED, true);
            } else {
